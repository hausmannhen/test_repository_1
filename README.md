...
- Arenen: Reviere der Zwischenbosse, Bossräume und rund jeder zehnte Wildnis-Bildschirm als Hinterhalt (per Seed festgelegt). Beim Betreten schließen Palisaden die Ränder, bis alle Gegner besiegt sind. Hinterhalte sperren nur beim ersten Mal. Arenen haben immer eine Kampftruhe mit besserer Beute, dazu gibt es Erfahrung.
