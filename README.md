...
- Sonderangriffe: Krieger lernen „Sturmangriff“ (Vorstoß, trifft alles auf dem Weg), Jäger „Pfeilhagel“ (fünf Geschosse im Fächer), beide ab Stufe 3 im Baum, kostenlos, 6 s Abklingzeit. Sie stehen in derselben Auswahl wie die Zauber, jeder Charakter wählt frei. Die Waffe entscheidet über die Wirkung: Stab für Zauber, Nahkampfwaffe für den Sturmangriff, Fernwaffe für den Pfeilhagel, sonst nur 60 %. Blutmagie skaliert nur noch mit Magie, Aderlass heilt höchstens seine Kosten zurück, Elementzauber haben 0,6 bis 1,8 s Abklingzeit, Manatränke füllen 35 %.
