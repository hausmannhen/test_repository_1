...
- Zwischenbosse: sieben mit Aufgabe in der Hauptgeschichte, sieben weitere ohne Aufgabe, je Region einer, feste Reviere mit Kampftruhe. Nach jedem Endboss trägt ein Sog den Spieler zurück zum Ausgang, sobald das Fenster mit den letzten Worten zu ist. Der Dorfbrunnen steht als kleiner Brunnen in der Dorfmitte, er ist das Ziel der Überfälle.
...
- Ton: Musik und Geräusche werden per WebAudio erzeugt, keine Dateien. Die Musik liegt bewusst über 200 Hz mit einer leisen Zupfstimme, weil Handylautsprecher darunter fast nichts wiedergeben. Musik wechselt mit der Region, Effekte für Hieb, Schuss, Treffer, Zauber, Beute, Aufstieg. Lautstärke und Stummschalten im Menü unter „Einstellungen“, gespeichert im Browser.
