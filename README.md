...
- Sonderangriffe: Krieger lernen „Sturmangriff“ (Vorstoß, trifft alles auf dem Weg), Jäger „Pfeilhagel“ (fünf Geschosse im Fächer), beide ab Stufe 3 im Baum, kostenlos, 6 s Abklingzeit. Sie stehen in derselben Auswahl wie die Zauber, jeder Charakter wählt frei. Der Sturmangriff geht nur mit Nahkampfwaffe, der Pfeilhagel nur mit Fernwaffe. Zauber gehen immer, ohne Stab aber nur mit 60 % Wirkung. Blutmagie skaliert nur noch mit Magie, Aderlass heilt höchstens seine Kosten zurück, Elementzauber haben 0,6 bis 1,8 s Abklingzeit, Manatränke füllen 35 %.
