...
- Zwischenbosse: sieben mit Aufgabe in der Hauptgeschichte, sieben weitere ohne Aufgabe, je Region einer, feste Reviere mit Kampftruhe. Nach jedem Endboss trägt ein Sog den Spieler zurück zum Ausgang: Er erwacht 3 Sekunden nachdem das Fenster mit den letzten Worten zu ist, zieht solange die Beute zum Spieler und nimmt liegen gebliebene Stücke mit. Der Dorfbrunnen steht als kleiner Brunnen in der Dorfmitte, er ist das Ziel der Überfälle.
- Affixe passen zur Waffe: Schwert und Bogen bekommen keine Magie- oder Mana-Affixe, der Stab keinen Angriffs-Affix, Köcher und Zauberbuch ebenso. Köcher und Zauberbuch fallen anderthalbmal so oft wie ein einzelner Schild.
- Nebenhand: Schilde für alle, mit Fernwaffe aber 20 % langsamer schießen. Köcher gibt Angriff, Krit und 5 % Feuerrate nur mit Fernwaffe, Zauberbuch Magie, Mana und Manafluss nur mit Stab, sonst zählt nur die Verteidigung.
- Sonderangriffe: Krieger lernen „Sturmangriff“ (Vorstoß, trifft alles auf dem Weg), Jäger „Pfeilhagel“ (fünf Geschosse im Fächer), beide ab Stufe 3 im Baum, kostenlos, 6 s Abklingzeit. Sie liegen auf einem eigenen Knopf neben „Zauber“ (Tastatur F), der Knopf zeigt den zur Waffe passenden Sonderangriff. Beide Knöpfe zeigen die Abklingzeit als Ring mit Restsekunden. Der Sturmangriff geht nur mit Nahkampfwaffe, der Pfeilhagel nur mit Fernwaffe. Zauber gehen immer, ohne Stab aber nur mit 60 % Wirkung. Blutmagie skaliert nur noch mit Magie, Aderlass heilt höchstens seine Kosten zurück, Elementzauber haben 0,6 bis 1,8 s Abklingzeit, Manatränke füllen 35 %.
...
- Ton: Musik und Geräusche werden per WebAudio erzeugt, keine Dateien. Die Musik liegt bewusst über 200 Hz mit einer leisen Zupfstimme, weil Handylautsprecher darunter fast nichts wiedergeben. Musik wechselt mit der Region; im Bossraum läuft, solange der Wächter lebt, ein schnelles Stück mit Pauke, Rassel und Lauf. Effekte für Hieb, Schuss, Treffer, Zauber, Beute, Aufstieg. Lautstärke und Stummschalten im Menü unter „Einstellungen“, gespeichert im Browser.
