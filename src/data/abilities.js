...
/* Endbosse: zwei aktive Angriffe plus eine Phase */
export const BOSS_ABILITIES = {
  0: ["wurzeln", "ruf"],            // Eichenkönig: Wurzelschlag am Spieler, ruft Spinnen
  1: ["stampfer", "wut"],           // Gebirgswächter: Bodenstampfer, Raserei ab 30 %
  2: ["odem", "stampfer"],          // Vargor: Feuerodem, Stampfer, dazu die Phasen
};
