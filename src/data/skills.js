...
export const SKILLS = {
  ...
  // Blutmagie
  blutmagie:    { id: "blutmagie",    branch: "magie",   name: "Blutmagie",       rank: 3, spell: "blutpfeil", level: 8, desc: "Zauber aus dem eigenen Leben. Schaden skaliert mit Magie und Angriff." },
