...
export const SPELLS = {
  ...
  wasserwoge:   { id: "wasserwoge",   name: "Wasserwoge",   element: "wasser",   kind: "nova",  cost: 14, dmg: 0.9, radius: 40, cd: 1.5, slow: 2,           desc: "Welle um dich herum, verlangsamt Getroffene." },
