...
export const MOBS = {
  schleim:     { name: "Schleim",       hp: 75, atk: 5,  spd: 20, size: 10, shape: "blob",  color: "#7fd35a", color2: "#3f8f2a", ai: "chase",   xp: 12,  gold: [1, 4] },
  ratte:       { name: "Riesenratte",   hp: 50, atk: 5,  spd: 42, size: 9,  shape: "quad",  color: "#8f6f55", color2: "#5a4030", ai: "chase",   xp: 12,  gold: [1, 5] },
  wolf:        { name: "Grauwolf",      hp: 70, atk: 7,  spd: 48, size: 11, shape: "quad",  color: "#8a8f96", color2: "#4c5057", ai: "chase",   xp: 18, gold: [2, 7] },
  spinne:      { name: "Riesenspinne",  hp: 120, atk: 10,  spd: 36, size: 12, shape: "blob",  color: "#3b2a4a", color2: "#c04070", ai: "chase",   xp: 26, gold: [3, 9] },
  waldgeist:   { name: "Waldgeist",     hp: 100, atk: 11, spd: 24, size: 11, shape: "ghost", color: "#7fe0c0", color2: "#2f8a70", ai: "ranged",  xp: 28, gold: [4, 12] },
  fledermaus:  { name: "Höhlenfledermaus", hp: 120, atk: 12, spd: 60, size: 9, shape: "bat",  color: "#5a3f6a", color2: "#2b1c33", ai: "erratic", xp: 40, gold: [2, 8] },
  golem:       { name: "Steingolem",    hp: 260, atk: 17, spd: 14, size: 14, shape: "golem", color: "#8b8577", color2: "#4a463f", ai: "chase",   xp: 75, gold: [8, 20] },
  skelett:     { name: "Skelett",       hp: 180, atk: 14, spd: 30, size: 11, shape: "skel",  color: "#e8e2d0", color2: "#8a8270", ai: "chase",   xp: 58, gold: [5, 14] },
  skorpion:    { name: "Sandskorpion",  hp: 260, atk: 20, spd: 34, size: 12, shape: "quad",  color: "#c9a24a", color2: "#7a5c1c", ai: "chase",   xp: 85, gold: [6, 16] },
  bandit:      { name: "Wüstenbandit",  hp: 220, atk: 21, spd: 40, size: 11, shape: "human", color: "#b5763a", color2: "#5c3a18", ai: "ranged",  xp: 85, gold: [12, 30] },
  sandwurm:    { name: "Sandwurm",      hp: 360, atk: 24, spd: 18, size: 14, shape: "blob", color: "#d9c27a", color2: "#8f7a36", ai: "chase",   xp: 115, gold: [10, 28] },
  moorkriecher:{ name: "Moorkriecher",  hp: 280, atk: 25, spd: 30, size: 13, shape: "blob",  color: "#4a5a3a", color2: "#1e2a14", ai: "chase",   xp: 98, gold: [10, 26] },
  sumpfschrat: { name: "Sumpfschrat",   hp: 360, atk: 27, spd: 22, size: 14, shape: "golem", color: "#5a6a48", color2: "#2a3420", ai: "chase",   xp: 110, gold: [12, 32] },
  hexe:        { name: "Moorhexe",      hp: 240, atk: 26, spd: 26, size: 11, shape: "human", color: "#4f6a3a", color2: "#22301a", ai: "ranged",  xp: 100, gold: [14, 34] },
...
export const BOSSES = {
  ...
  1: { base: "golem",     name: "Gebirgswächter",     hpMult: 10, atkMult: 2.4, size: 24, color: "#6f7a90", color2: "#2a3040" },
  2: { base: "drache",    name: "Aschedrache Vargor", hpMult: 8,  atkMult: 1.3, size: 26, color: "#e04a2a", color2: "#3a0a0a" },
};

export function makeMob(typeId, level, x, y, bossDef = null) {
  const base = MOBS[typeId];
  // Grundwerte tragen den Gebietsunterschied, die Stufe wächst sanft (Elites, Überfälle, Dungeons über Gebietsstufe)
  ...
  const m = {
    ...
    atk: Math.round(base.atk * (1 + (level - 1) * 0.05) * (bossDef ? bossDef.atkMult : 1)),
    ...
    ai: base.ai, xp: Math.round(base.xp * (1 + (level - 1) * 0.06) * (bossDef ? (bossDef.mini || bossDef.leader ? 5 : 12) : 1)), gold: base.gold,
